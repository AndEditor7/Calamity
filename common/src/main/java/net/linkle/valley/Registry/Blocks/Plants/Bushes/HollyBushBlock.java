...
public class HollyBushBlock extends PlantBlock implements Fertilizable {
    public static final IntProperty AGE;
    private static final VoxelShape SMALL_SHAPE;
    private static final VoxelShape LARGE_SHAPE;

    public HollyBushBlock(Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(HOLLY_BUSH.get());
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!bl && player.getStackInHand(hand).getItem() == Items.BONE_MEAL) {
            ...
            dropStack(world, pos, new ItemStack(HOLLY_BUSH.get(), j + (bl ? 1 : 0)));
