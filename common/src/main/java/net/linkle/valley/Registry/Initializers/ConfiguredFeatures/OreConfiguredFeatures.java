...
import net.linkle.valley.Registry.Utils.BiomeMods;
import net.linkle.valley.Registry.Utils.BiomeSelectors;
...
public class OreConfiguredFeatures {
    ...
    public static void initialize() {
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.JUNGLE_EDGE,BiomeKeys.JUNGLE_HILLS, BiomeKeys.JUNGLE, BiomeKeys.MODIFIED_JUNGLE_EDGE, BiomeKeys.BAMBOO_JUNGLE_HILLS, BiomeKeys.BAMBOO_JUNGLE),
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN, BiomeKeys.DEEP_WARM_OCEAN, BiomeKeys.WARM_OCEAN, BiomeKeys.LUKEWARM_OCEAN, BiomeKeys.FROZEN_OCEAN, BiomeKeys.DEEP_FROZEN_OCEAN, BiomeKeys.DEEP_COLD_OCEAN, BiomeKeys.COLD_OCEAN),
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.SWAMP, BiomeKeys.SWAMP_HILLS),
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.DARK_FOREST, BiomeKeys.DARK_FOREST_HILLS),
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.DESERT, BiomeKeys.DESERT_HILLS, BiomeKeys.DESERT_LAKES, BiomeKeys.BADLANDS, BiomeKeys.BADLANDS_PLATEAU, BiomeKeys.ERODED_BADLANDS, BiomeKeys.WOODED_BADLANDS_PLATEAU, BiomeKeys.MODIFIED_WOODED_BADLANDS_PLATEAU),
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.BADLANDS, BiomeKeys.BADLANDS_PLATEAU, BiomeKeys.ERODED_BADLANDS, BiomeKeys.WOODED_BADLANDS_PLATEAU, BiomeKeys.MODIFIED_WOODED_BADLANDS_PLATEAU),
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.BADLANDS, BiomeKeys.BADLANDS_PLATEAU, BiomeKeys.ERODED_BADLANDS, BiomeKeys.WOODED_BADLANDS_PLATEAU, BiomeKeys.MODIFIED_WOODED_BADLANDS_PLATEAU, BiomeKeys.DESERT, BiomeKeys.DESERT_HILLS, BiomeKeys.DESERT_LAKES),
        ...
        BiomeMods.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.ICE_SPIKES,BiomeKeys.SNOWY_TAIGA,BiomeKeys.SNOWY_TAIGA_HILLS,BiomeKeys.SNOWY_BEACH,BiomeKeys.SNOWY_TAIGA_MOUNTAINS,BiomeKeys.SNOWY_MOUNTAINS,BiomeKeys.SNOWY_TUNDRA, BiomeKeys.ICE_SPIKES),
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.MOUNTAINS, BiomeKeys.MOUNTAIN_EDGE, BiomeKeys.WOODED_MOUNTAINS, BiomeKeys.GRAVELLY_MOUNTAINS, BiomeKeys.TAIGA_MOUNTAINS, BiomeKeys.SNOWY_TAIGA_MOUNTAINS, BiomeKeys.MODIFIED_GRAVELLY_MOUNTAINS, BiomeKeys.ICE_SPIKES),
        ...
        BiomeMods.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreSaltOverworld);
        ...
        BiomeMods.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreMixedOverworld);
        ...
        BiomeMods.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, oreSaltpeterOverworld);
        ...
        BiomeMods.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, mudOverworld);
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.BAMBOO_JUNGLE, BiomeKeys.JUNGLE,BiomeKeys.JUNGLE_HILLS, BiomeKeys.BAMBOO_JUNGLE_HILLS, BiomeKeys.MODIFIED_JUNGLE), GenerationStep.Feature.UNDERGROUND_ORES, volcSandOverworld);
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.BAMBOO_JUNGLE, BiomeKeys.JUNGLE,BiomeKeys.JUNGLE_HILLS, BiomeKeys.BAMBOO_JUNGLE_HILLS, BiomeKeys.MODIFIED_JUNGLE), GenerationStep.Feature.UNDERGROUND_ORES, volcStoneOverworld);
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.NETHER_WASTES, BiomeKeys.CRIMSON_FOREST, BiomeKeys.WARPED_FOREST), GenerationStep.Feature.UNDERGROUND_ORES, oreSaltNether);
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.NETHER_WASTES, BiomeKeys.CRIMSON_FOREST, BiomeKeys.WARPED_FOREST), GenerationStep.Feature.UNDERGROUND_ORES, oreCoalNether);
        ...
        BiomeMods.addFeature(BiomeSelectors.includeByKey(BiomeKeys.TAIGA,BiomeKeys.TAIGA_HILLS, BiomeKeys.TAIGA_MOUNTAINS, BiomeKeys.SNOWY_TAIGA_HILLS, BiomeKeys.SNOWY_TAIGA_MOUNTAINS, BiomeKeys.GIANT_SPRUCE_TAIGA, BiomeKeys.SNOWY_TAIGA,BiomeKeys.GIANT_SPRUCE_TAIGA_HILLS, BiomeKeys.GIANT_TREE_TAIGA_HILLS, BiomeKeys.GIANT_SPRUCE_TAIGA, BiomeKeys.GIANT_TREE_TAIGA),
